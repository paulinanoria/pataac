...
============================================================================================================================================*/
	...
	// Contact Us
		...
		// Form Submit Validation
			// $(".contact-2 form input[type=submit]").click(function(event) {
			// 	event.preventDefault();
			...
			// 	if(current_form.find("input[type=text]").val() == "" || current_form.find("number").val() == "" ){

			// 		current_form.find("input").each(function(index, el) {
			...
			// 		current_form.find("input:not([type=button])").each(function(index, el) {
		...
		// Form Submit Validation
			...
			// 	if(current_form.find("input[type=text]").val() == "" || current_form.find("input[type=email]").val() == "" || current_form.find("textarea").val() == "" || current_form.find("password").val() == "" || current_form.find("number").val() == "" ){
...
// ;
$(function () {
   $("#id_disease").attr("size",$("#id_disease option").length);
});

var select = document.getElementById('id_disease');
